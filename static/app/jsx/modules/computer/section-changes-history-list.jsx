class SectionChangesHistoryListComputer extends React.Component {
    ...
    constructor(props) {
        ...
        this.baseState = {
            ...
            headers:  [
                {value: 'pk', label: 'History ID'},
                {value: 'quarter', label: 'Date / Time'},
                {value: 'schedule', label: 'Comment'},
                {value: 'technician', label: 'Change By'},
                {value: 'status', label: 'Change Reason'},
            ]
        }
